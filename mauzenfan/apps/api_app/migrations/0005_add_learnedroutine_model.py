...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api_app._app', '0004_add_is_active_to_safezone'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='learned_routines', to='api_app._app.child')),
            ],
            options={
