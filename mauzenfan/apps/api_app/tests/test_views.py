...
from rest_framework.test import api_app.TestCase
...
class ChildViewSetTests(api_app.TestCase):
    def setUp(self):
...
class SafeZoneViewSetTests(api_app.TestCase):
    def setUp(self):
...
class LocationUpdateViewTests(api_app.TestCase):
    def setUp(self):
...
class LocationUpdateViewAlertGenerationTests(api_app.TestCase):
    def setUp(self):
...
class ChildCheckInViewTests(api_app.TestCase):
    def setUp(self):
...
class SOSAlertViewTests(api_app.TestCase):
    def setUp(self):
...
class LocationRetrievalViewTests(api_app.TestCase):
    def setUp(self):
...
class EtaSharingViewSetTests(api_app.TestCase):
    def setUp(self):
...
class MessagingViewTests(api_app.TestCase):
    def setUp(self):
...
class DeviceRegistrationViewTests(api_app.TestCase):
    def setUp(self):
