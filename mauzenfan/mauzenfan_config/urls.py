...
from drf_spectacular.views import SpectacularapiappView, SpectacularRedocView, SpectacularSwaggerView

schema_urlpatterns = [
    path('api_app/schema/', SpectacularapiAppView.as_view(), name='schema'),
    # Optional UI:
